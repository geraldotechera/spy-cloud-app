...
const emergencyCategories: EmergencyCategory[] = [
  ...
  },
  {
    ...
    contacts: [
      ...
      { country: "España", flag: "🇪🇸", label: "Embajada Uruguay en Madrid", number: "+34 91 308 0400" },
      { country: "Francia", flag: "🇫🇷", label: "Embajada Uruguay en París", number: "+33 1 4500 7710" },
      { country: "Italia", flag: "🇮🇹", label: "Embajada Uruguay en Roma", number: "+39 06 807 4549" },
      { country: "Suiza", flag: "🇨🇭", label: "Embajada Uruguay en Berna", number: "+41 31 382 1060" },
    ],
  },
  {
    id: "consular",
    ...
    color: "bg-cyan-600",
    contacts: [
      { country: "España", flag: "🇪🇸", label: "Consulado Uruguay en Barcelona", number: "+34 93 201 0766" },
      { country: "Francia", flag: "🇫🇷", label: "Consulado Uruguay en París", number: "+33 1 4500 7710" },
      { country: "Italia", flag: "🇮🇹", label: "Consulado Uruguay en Milán", number: "+39 02 8909 3747" },
    ],
  },
]
